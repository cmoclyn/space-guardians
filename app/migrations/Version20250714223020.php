 ...
 */
final class Version20250714223020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player ALTER original_owner_id SET NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player ALTER original_owner_id DROP NOT NULL');
    }
}
